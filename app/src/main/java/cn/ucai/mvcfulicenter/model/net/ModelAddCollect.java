...
public class ModelAddCollect implements IModelAddCollect {
    @Override
    public void addCollectGood(Context context, int goodsId, String userName, OnCompleteListener<MessageBean> listener) {
